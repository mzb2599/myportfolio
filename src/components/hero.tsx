...
export default function Hero() {
  ...
  const roles = ["Full Stack Developer", "React Specialist", "Cloud Engineer", "AI Enthusiast"]
      ...
      <div className="container mx-auto px-6 text-center relative z-10">
        ...
        >
          <div className="mb-8">
            ...
            <h2 className="text-2xl md:text-3xl font-light mb-6 text-gray-300">Aliraza Bhojani</h2>
          </div>

          <div className="mb-8 h-16 flex items-center justify-center">
            <p className="text-xl md:text-2xl text-purple-400 font-medium">
              <span className="inline-block animate-pulse">{">"}</span>
              <span className="ml-2 transition-all duration-500">{roles[currentRole]}</span>
              <span className="inline-block animate-pulse ml-1">_</span>
            </p>
          </div>

          <p className="text-lg md:text-xl text-gray-300 mb-8 max-w-3xl mx-auto leading-relaxed">
            Highly skilled Software Developer with expertise in cloud technologies, MERN Stack development, and
            Artificial Intelligence. Passionate about creating innovative solutions and staying at the forefront of
            technology.
          </p>
          ...
          <div className="flex justify-center space-x-6">
            {[
              { icon: Github, href: "https://github.com/mzb2599", label: "GitHub" },
              { icon: Linkedin, href: "https://www.linkedin.com/in/mzakibhojani", label: "LinkedIn" },
              { icon: Mail, href: "mailto:mohammedzakibhojani@gmail.com", label: "Email" },
              { icon: ExternalLink, href: "https://medium.com/@mzaki2599", label: "Medium" },
            ].map((social, index) => (
              <a
                key={social.label}
                href={social.href}
              ...
              >
                <social.icon size={24} className="text-gray-300 hover:text-purple-400 transition-colors duration-300" />
              </a>
            ))}
          </div>
        </div>
